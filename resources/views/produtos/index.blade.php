    ...
    <div style="margin-bottom: 150px;" class="row">
        @foreach ($produtos as $produto)
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="{{ asset('storage/' . $produto->imagem) }}" class="card-img-top img-custom" alt="{{ $produto->nome }}">
                    <div class="card-body">
                        <h5 class="card-title">{{ $produto->nome }}</h5>
                        <p class="card-text"><strong>Preço:</strong> R$ {{ number_format($produto->preco, 2, ',', '.') }}</p>
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#produtoModal{{ $produto->id }}">
                            Ver Detalhes
                        </button>
                    </div>
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="{{ asset('storage/' . $produto->imagem) }}" class="img-fluid mb-3" alt="{{ $produto->nome }}">
